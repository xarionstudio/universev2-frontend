      ...
      {toasts.map((toast) => {
        ...
        return (
          <div
            ...
            role="status"
            className={cn(
              "glass-card animate-toast-in flex items-start gap-3 rounded-icon border-l-3 px-4 py-3",
              accent[toast.type]
            )}
          >
            <Icon
            ...
            <div className="min-w-0 flex-1">
              <b className="block text-sm leading-snug font-semibold">{toast.title}</b>
              {toast.detail ? (
