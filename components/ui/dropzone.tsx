...
function Dropzone({
  ...
  onPick?: () => void;
  /* `file` menyertai nama supaya pemanggil yang benar-benar mengunggah (mis.
     foto karyawan) menerima berkasnya; pemanggil lama yang hanya memakai nama
     tetap cocok tanpa perubahan. */
