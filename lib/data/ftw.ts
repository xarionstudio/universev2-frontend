...
export function ftwData(lang: Lang): FtwRecord[] {
  ...
  const j = (h: number, m: number | string) =>
    en ? `${h} h ${m} m` : `${h} j ${m} m`
  return [
    { name: "First Angel Paustine", nik: "503264133", dept: "Operation", shift: "siang", sleep: j(7, 20), st: "fit", hist: [1, 1, 1, 1, 0, 1, 1] },
    { name: "Rahmat Hidayat", nik: "503264134", dept: "SDI", shift: "siang", sleep: j(6, 45), st: "fit", hist: [1, 1, 1, 1, 1, 1, 1] },
    { name: "Budi Santoso", nik: "503264135", dept: "HRGA", shift: "siang", sleep: j(3, 40), st: "kurang", hist: [1, 0, 1, 0, 0, 1, 0] },
    { name: "Siti Nurhaliza", nik: "503264136", dept: "Operation", shift: "siang", sleep: j(7, "05"), st: "fit", hist: [1, 1, 1, 1, 1, 0, 1] },
    { name: "Andi Prasetyo", nik: "503264137", dept: "Plant", shift: "siang", sleep: j(5, 30), st: "kurang", hist: [1, 1, 0, 1, 1, 1, 0] },
    { name: "Dewi Lestari", nik: "503264138", dept: "SDI", shift: "siang", sleep: j(8, 10), st: "fit", hist: [1, 1, 1, 1, 1, 1, 1] },
    { name: "Joko Widodo S.", nik: "503264139", dept: "Operation", shift: "siang", sleep: "—", st: "belum", hist: [1, 1, 1, 0, 1, -1, -1] },
    { name: "Agus Salim", nik: "503264141", dept: "Plant", shift: "malam", sleep: j(3, 55), st: "kurang", hist: [0, 1, 0, 1, 0, 0, 0] },
    { name: "Maya Sari", nik: "503264142", dept: "Operation", shift: "malam", sleep: j(6, 15), st: "fit", hist: [1, 1, 1, 1, 1, 1, 1] },
    { name: "Hendra Gunawan", nik: "503264143", dept: "Plant", shift: "malam", sleep: "—", st: "belum", hist: [1, 1, 1, 1, -1, 1, -1] },
  ]
}
